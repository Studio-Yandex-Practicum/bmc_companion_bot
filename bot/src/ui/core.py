...
class MenuNames:
    ...
    start_menu = MenuElement(
        ...
        answers={
            "to_test": "Тесты",
            "to_meeting": "Записаться к психологу",
            "admin": "Меню администратора",
        },
    )
    admin_menu = MenuElement(
        name="Меню администратора",
        result="{}, добро пожаловать в меню администратора.",
        answers={
            "home": "Домой - возврат в главное меню",
            "list_admins": "Список админов",
            "list_psychologists": "Список психологов",
            "tests": "Тесты",
        },
    )
