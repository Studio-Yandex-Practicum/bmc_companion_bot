...
Revision ID: ae96c0d45554
Revises: ff6fad2ffb32
Create Date: 2023-03-04 00:43:31.181206
...
revision = "ae96c0d45554"
down_revision = "ff6fad2ffb32"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["meeting_id"],
            ["meetings.id"],
            name=op.f("fk_assessment_of_the_meeting_meeting_id_meetings"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_assessment_of_the_meeting_user_id_users")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_assessment_of_the_meeting")),
    )
...
def downgrade():
    ...
    op.drop_table("assessment_of_the_meeting")
    # ### end Alembic commands ###
